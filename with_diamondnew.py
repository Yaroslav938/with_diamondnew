...
# --- Настройки путей ---
# Умное определение пути в зависимости от ОС (Windows или Linux/Streamlit Cloud)
if platform.system() == "Windows":
    DEFAULT_DIAMOND_PATH = r"C:\Users\diamond\diamond.exe"
else:
    # В Linux (в т.ч. Streamlit Cloud, если установлен через packages.txt) 
    # команда доступна просто как "diamond"
